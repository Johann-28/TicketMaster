...
> ### Tickets
  > ![Tabla de tickets](/TicketMaster/img/Ticket.png)
    > Esta tabla será el resultado de todo el proceso de compra, como podemos ver en su mayoría se conforma por FK, el que un boleto tenga un ticket significa que ya ha sido vendido al igual que si un asiento tiene relacionado un ticket, el idCliente será para generar un buen formato para imprimir el ticket al igual que la forma de pago (efectivo o tarjeta, por ejemplo)

> ### Formas de Pago
  > ![Tabla de formas de pago](/TicketMaster/img/FormasDePago.png)
    > Esta tabla guardara los registros de los tipos de formas de pago
